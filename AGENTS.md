...
- `kitwright-unity-mcp-workflow` v1.0.0 - Efficient workflow for using Unity MCP to edit, import, compile, inspect, and test Unity projects.
...
- Project root: `F:\Unity\UnityProj\Heat Abnormal`
- Product name: `Heat Abnormal`
